...
description: >
  Generates a complete BLACKPINK show plan with stage directions and production notes. Use when a workflow has a finalized setlist and needs the full performance plan.
tools:
  - readFile
  - search/codebase
